...
public class RemoteApiKeyProvider_SingleRemoteApiKeyFetchingTest extends RemoteApiKeyProvider_AbstractTestSetup {
    ...
    public void nullApiKeyResponseEntityShouldCauseException() {
        ...
        assertThrows(ApiKeyFetchingFailedException.class, () -> remoteApiKeyProvider.requestApiKeyFromAdmin(someApiKeyValue));
    }
    ...
    public void validApiKeyResponseEntityFromAdminShouldDeliverApiKey() {
        ...
        assertSame(remoteApiKeyProvider.requestApiKeyFromAdmin(apiKey.getKeyValue()), apiKey);
    }
    ...
    public void nonOkHttpStatusShouldCauseException() {
        ...
        assertThrows(ApiKeyFetchingFailedException.class, () -> remoteApiKeyProvider.requestApiKeyFromAdmin(hashedApiKey.hashedKeyValue));
    }
    ...
    public void apiKeyNotFoundByAdminAndNonOkHttpStatusShouldCauseException() {
        ...
        assertThrows(ApiKeyFetchingFailedException.class,
                () -> remoteApiKeyProvider.requestApiKeyFromAdmin(hashedApiKey.hashedKeyValue));
    }
